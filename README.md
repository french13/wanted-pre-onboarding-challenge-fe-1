...
<img src='/client/public/images/change1-1.png' width='400'>
    ...
    - 해당 function을 포함하고 있는 components의 이름이 Login이라 기존login이라고 적혀있던 function 명을 signIn으로 교체
...
##### 2. 회원가입 페이지 리팩토링
 ...
 - 수정 전
 <img src='/client/public/images/change2-1.png' width='200'>

 - 수정 후
 <img src='/client/public/images/change2.png' width='300'>
